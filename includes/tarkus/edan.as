...
public function edanDrinksSexThird():void
{
	...
	output("\n\nOne of the girls sits alongside you and runs her tongue up the base of Edan’s cock, clearly not shy at all about participating in a group blowjob. Another one slips under her to fondle and lick his taut ballsack, your combined actions eliciting a groan from above. Hey, this is kinky AND kind of fun. The third girl, though, catches you offguard by pulling down your [pc.lowerGarments], your [pc.vaginas] ");
	if (pc.hasCock()) output("and [pc.cocks] suddenly bared to the air.");
	else output("suddenly bared to the air.");
